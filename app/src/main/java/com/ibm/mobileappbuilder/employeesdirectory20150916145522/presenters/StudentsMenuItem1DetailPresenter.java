...
public class StudentsMenuItem1DetailPresenter extends BasePresenter implements DetailCrudPresenter<EmployeesDBDSItem>,
      Datasource.Listener<EmployeesDBDSItem> {

    private final CrudDatasource<EmployeesDBDSItem> datasource;
    private final DetailView view;

    public StudentsMenuItem1DetailPresenter(CrudDatasource<EmployeesDBDSItem> datasource, DetailView view){
