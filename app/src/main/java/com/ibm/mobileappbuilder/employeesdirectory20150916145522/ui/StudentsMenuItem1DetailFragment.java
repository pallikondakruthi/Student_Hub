...
import com.ibm.mobileappbuilder.employeesdirectory20150916145522.presenters.StudentsMenuItem1DetailPresenter;
...
public class StudentsMenuItem1DetailFragment extends ibmmobileappbuilder.ui.DetailFragment<EmployeesDBDSItem> implements ShareBehavior.ShareListener  {

    private CrudDatasource<EmployeesDBDSItem> datasource;
    public static StudentsMenuItem1DetailFragment newInstance(Bundle args){
        StudentsMenuItem1DetailFragment fr = new StudentsMenuItem1DetailFragment();
        fr.setArguments(args);

        return fr;
    }

    public StudentsMenuItem1DetailFragment(){
        super();
    }
    ...
    public void onCreate(Bundle state) {
        ...
        setPresenter(new StudentsMenuItem1DetailPresenter(
    ...
    protected int getLayout() {
        return R.layout.studentsmenuitem1detail_detail;
    }
