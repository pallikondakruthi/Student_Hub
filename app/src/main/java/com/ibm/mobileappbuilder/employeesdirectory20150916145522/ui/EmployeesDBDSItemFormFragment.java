...
import com.ibm.mobileappbuilder.employeesdirectory20150916145522.presenters.StudentsMenuItem1FormPresenter;
...
public class EmployeesDBDSItemFormFragment extends FormFragment<EmployeesDBDSItem> {
    ...
    public void onCreate(Bundle state) {
        ...
        setPresenter(new StudentsMenuItem1FormPresenter(
    ...
    protected int getLayout() {
        return R.layout.studentsmenuitem1_form;
    }
